...
import { LegendLinterPluginManager } from './LegendLinterPluginManager';
import { getRootElement } from '@finos/legend-art';
import type { LegendLinterConfigData } from './LegendLinterConfig';
import { LegendLinterConfig } from './LegendLinterConfig';
...
export class LegendLinter extends LegendApplication {
  declare config: LegendLinterConfig;
  declare pluginManager: LegendLinterPluginManager;

  static create(): LegendLinter {
    const application = new LegendLinter(LegendLinterPluginManager.create());
  ...
  async configureApplication(
    ...
    return new LegendLinterConfig(configData, versionData, baseUrl);
  }
